...
public class CentralBarcodeFocusingProcessor extends FocusingProcessor<Barcode> {
    ...
    private CentralBarcodeFocusingProcessor(Detector<Barcode> detector, Tracker<Barcode> tracker) {
    ...
    public static class Builder {
        private CentralBarcodeFocusingProcessor processor;

        public Builder(Detector<Barcode> detector, Tracker<Barcode> tracker) {
            this.processor = new CentralBarcodeFocusingProcessor(detector, tracker);
        }

        public Builder setMaxGapFrames(int maxGapFrames) {
            this.processor.zza(maxGapFrames);
            return this;
        }

        public CentralBarcodeFocusingProcessor build() {
